...
\large \color{black}\sffamily %default font size
...
\begin{minipage}{0.45\textwidth}
\begin{center}
\textbf{Devices with no spatial dimension (0D = point)}\\
\vspace{2cm}
%top diagram
\begin{tikzpicture}[scale=2]
%grid
...
\begin{figure}[H]
        \includegraphics[width=\textwidth]{graphics/arrowsMoving-00.pdf}
\end{figure}
\textbf{Score for single vibe motor playing simple [solo]-rhythm}.
\begin{itemize}
\item Time = horizontal, x-axis
\item Pitch = vertical, y-axis
\item Notation affects only one component
\end{itemize}
\end{center}
\end{minipage}};
\end{tikzpicture}
...
\begin{minipage}{0.45\textwidth}
\begin{center}
\textbf{Devices with one spatial dimension (1D = linear)}\\
\vspace{2cm}
%top diagram
\begin{tikzpicture}[scale=2]
%grid
...
\begin{figure}[H]
        \includegraphics[width=\textwidth]{graphics/arrowsMoving-00.pdf}
\end{figure}
\textbf{Score for a line of vibe motors}.
\begin{itemize}
\item Time = horizontal, x-axis
\item Pitch = vertical, y-axis
\item Notation affects five components
\item Each component should be independently addressable
\end{itemize}
\end{center}
\end{minipage}};
\end{tikzpicture}
...
\begin{minipage}{0.45\textwidth}
\begin{center}
\textbf{Devices with two spatial dimension (2D = planar)}\\
\vspace{2cm}
%top diagram
\begin{tikzpicture}[scale=2]
%grid
...
\begin{figure}[H]
        \includegraphics[width=\textwidth]{graphics/arrowsMoving-00.pdf}
\end{figure}
Score for an array of vibe motors.
\end{center}
\end{minipage}};
\end{tikzpicture}
\end{center}
