...
\begin{minipage}{0.45\textwidth}
\begin{center}
\color{red} \textbf{Device with no spatial dimension (0D = point)}\\
\color{black}
\vspace{2cm}
%top diagram
\begin{tikzpicture}[scale=2]
...
\begin{figure}[H]
        \includegraphics[width=\textwidth]{graphicsPoster/arrowsMoving-00.pdf}
\end{figure}
\textbf{Score for single vibe motor playing simple solo rhythm}
\begin{itemize}
\item Time = horizontal, x-axis
\item Pitch = vertical, y-axis; single pitch for single component
\item Unpitched notation also suitable
...
%bottom figure (musical staff)
\begin{figure}[H]
        \includegraphics[width=0.9\textwidth]{graphicsPoster/arrowsMoving-5-4.pdf}
\end{figure}
\textbf{Score for a linear array of vibe motors}
\begin{itemize}
